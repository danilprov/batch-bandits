...
def data_randomizer(pickle_file, seed=None):
    ...
    X = tst_smpl.iloc[:, :-2].to_numpy()
    A = tst_smpl.iloc[:, -2].to_numpy()
    Y = tst_smpl.iloc[:, -1].to_numpy()
